...
final class Phpill {
	...
	public static function setup() 
	{
		...
		Event::add('system.routing', array('System\Libraries\Router', 'find_uri'));
		Event::add('system.routing', array('System\Libraries\Router', 'setup'));
	...
	public static function & instance()
	{
		if (self::$instance === NULL)
		{
			...
			if (System\Libraries\Router::$method[0] === '_')
			{
			...
			require System\Libraries\Router::$controller_path;

			try
			{
				// Start validation of the controller
				$class = new ReflectionClass(ucfirst(System\Libraries\Router::$controller));
			}
			...
			try
			{
				...
				$method = $class->getMethod(System\Libraries\Router::$method);
				...
				// Default arguments
				$arguments = System\Libraries\Router::$arguments;
			}
			catch (ReflectionException $e)
			{
				// Use __call instead
				...
				$arguments = array(System\Libraries\Router::$method, System\Libraries\Router::$arguments);
			}
	...
	public static function debug()
	{
		...
		{
			$output[] = '<pre>('.gettype($var).') '.System\Helpers\Html::specialchars(print_r($var, TRUE)).'</pre>';
		}
		...
		foreach ($trace as $entry)
		{
			...
			if (isset($entry['args']) AND is_array($entry['args']))
			{
				...
				while ($arg = array_shift($entry['args']))
				{
					...
					$temp .= $sep. System\Helpers\Html::specialchars(print_r($arg, TRUE));
...
class Phpill_404_Exception extends Phpill_Exception {
	...
	public function __construct($page = FALSE, $template = FALSE)
	{
		if ($page === FALSE)
		{
			...
			$page = System\Libraries\Router::$current_uri.System\Libraries\Router::$url_suffix.System\Libraries\Router::$query_string;
		}
