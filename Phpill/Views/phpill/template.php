...
<head>
	...
	<title><?php echo Phpill\Helpers\Html::specialchars($title) ?></title>

	<style type="text/css">
	html { background: #83c018 url(<?php echo url::base(FALSE) ?>phpill.png) 50% 0 no-repeat; }
...
<body>
	...
	<h1><?php echo Phpill\Helpers\Html::specialchars($title) ?></h1>
	<?php echo $content ?>

	<p class="copyright">
		Rendered in {execution_time} seconds, using {memory_usage} of memory<br />
		Copyright ©2007–2008 Phpill Team
	</p>
