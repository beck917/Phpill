...
$lang = array
(
	'there_can_be_only_one' => 'There can be only one instance of Phpill per page request',
	...
	'no_controller'         => 'Phpill was not able to determine a controller to process this request: %s',
	'page_not_found'        => 'The page you requested, %s, could not be found.',
	'stats_footer'          => 'Loaded in {execution_time} seconds, using {memory_usage} of memory. Generated by Phpill v{phpill_version}.',
