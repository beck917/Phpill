...
class Database {
	...
	public function __construct($config = array())
	{
		...
		// Set driver name
		$driver = "System\\Libraries\\Drivers\\Database\\".ucfirst($this->config['connection']['type']);
		...
		// Validate the driver
		if ( ! ($this->driver instanceof \System\Libraries\Drivers\Database))
	 ...
	 * @return  \System\Libraries\Drivers\Database_Result
	 */
	 ...
	 * @param   string  table name
	 * @param   array   array of key/value pairs to insert
	 * @return  \System\Libraries\Drivers\Database_Result  Query result
	 */
