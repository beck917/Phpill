...
class Url {
	...
	public static function base($index = FALSE, $protocol = FALSE)
	{
		if ($protocol == FALSE)
		{
			...
			$protocol = \Phpill::config('core.site_protocol');
		}

		// Load the site domain
		$site_domain = (string) \Phpill::config('core.site_domain', TRUE);
		...
		if ($index === TRUE AND $index = \Phpill::config('core.index_page'))
		{
	...
	public static function site($uri = '', $protocol = FALSE)
	{
		...
		{
			// Add path suffix
			$path .= \Phpill::config('core.url_suffix');
		}
