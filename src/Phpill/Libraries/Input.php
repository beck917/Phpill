...
class Input {
	...
	{
		// Use XSS clean?
		$this->use_xss_clean = (bool) \Phpill::config('core.global_xss_filtering');
		...
		if (self::$instance === NULL)
		{
			...
			if (get_magic_quotes_runtime())
			{
				...
				\Phpill::log('debug', 'Disable magic_quotes_runtime! It is evil and deprecated: http://php.net/magic_quotes');
			}
			...
			if (get_magic_quotes_gpc())
			{
				...
				\Phpill::log('debug', 'Disable magic_quotes_gpc! It is evil and deprecated: http://php.net/magic_quotes');
			}
			...
			if (ini_get('register_globals'))
			{
				...
				\Phpill::log('debug', 'Disable register_globals! It is evil and deprecated: http://php.net/register_globals');
			}
			...
			\Phpill::log('debug', 'Global GET, POST and COOKIE data sanitized');
		}
	}
	 ...
	 * @return  mixed
	 */
	public function _post($key = array(), $default = NULL, $xss_clean = FALSE)
	{
	...
	public function ip_address()
	{
		...
		if ( !\Phpill\Helpers\Valid::ip($this->ip_address))
		{
			// Use an empty IP
	...
	public function xss_clean($data, $tool = NULL)
	{
		if ($tool === NULL)
		{
			...
			$tool = \Phpill::config('core.global_xss_filtering');
		}
		...
		switch ($tool)
		{
			case 'htmlpurifier':
				...
				{
					// Load HTMLPurifier
					require \Phpill::find_file('vendor', 'htmlpurifier/HTMLPurifier.auto', TRUE);
