...
class Mysql extends \Phpill\Libraries\Drivers\Database {
	...
	public function __construct($config)
	{
		...
		\Phpill::log('debug', 'MySQL Database Driver Initialized');
	}
	...
	public function setWhereArray($keys)
	{
	...
	public function list_fields($table)
	{
		...
		if (!isset($tables[$table]))
			throw new Phpill_Database_Exception('database.table_not_found', $table);
	...
	public function begin()
	{
		...
		return (bool)$this->link->query('START TRANSACTION');
	}
 ...
 * MySQL Result
 */
class Mysql_Result extends \Phpill\Libraries\Drivers\Database_Result {
	...
	public function __construct($result, $link, $object = TRUE, $sql)
	{
		...
		elseif (is_bool($result))
		{
			...
			{
				// SQL error
				throw new Phpill_Database_Exception('database.error', mysql_error($link).' - '.$sql);
			}
			else
			{
	...
	public function result_array($object = NULL, $type = MYSQL_ASSOC)
	{
		...
		else
		{
			...
			{
				$type = (is_string($this->return_type) AND \Phpill::auto_load($this->return_type)) ? $this->return_type : 'stdClass';
			}
		}
