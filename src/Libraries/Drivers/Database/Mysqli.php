 ...
 */
namespace Phpill\Libraries\Drivers\Database;
class Mysqli extends \Phpill\Libraries\Drivers\Database\Mysql {
	...
	public function set_charset($charset)
	{
		if ($this->link->set_charset($charset) === FALSE)
			throw new \Phpill\Libraries\Phpill_Database_Exception('database.error', $this->show_error());
	}
 ...
 * MySQLi Result
 */
class Phpill_Mysqli_Result extends \Phpill\Libraries\Drivers\Database_Result {
	...
	public function __construct($link, $object = TRUE, $sql)
	{
		...
		{
			// SQL error
			throw new \Phpill\Libraries\Phpill_Database_Exception('database.error', $this->link->error.' - '.$sql);
		}
		else
		{
